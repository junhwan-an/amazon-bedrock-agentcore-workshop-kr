...
class TraceData:
    ...
    def get_tool_execution_spans(self, tool_name_filter: Optional[str] = None) -> List[str]:
        ...
        for span in self.spans:
            ...
            # OpenTelemetry span의 operation name이 "execute_tool"인지 확인
...
class EvaluationRequest:
    ...
    def to_api_request(self) -> tuple:
        ...
        """
        # Bedrock Agent Evaluations API 요청 형식으로 변환
